...
public class NFVSolver {
	...
	public static void main(String[] args) throws Exception {
		...
		problem_vars[1] =numR +1 +getCount(REdge)*numS +getCount(SEdge) + numS;
		...
		ProblemVirtualization instance = new ProblemVirtualization(problem_vars, SEdge, REdge, demand, C, G, R, numS, numR, trust, thresh, sum);
		
		
		//instance.setProbVars(problem_vars);
//		instance.setSubMatrix(SEdge); 
//		instance.setReqMatrix(REdge);
//		instance.setBWDemand(demand);
//		instance.setSubBW(C);
//		instance.setCPUDemand(G);
//		instance.setSubCPU(R);
//		instance.setNumS(numS);
//		instance.setNumR(numR);
//		instance.setTrust(trust);
//		instance.setThresh(thresh);
